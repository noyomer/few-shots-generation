...
###  Train
To train the model on your own batch of images, put the desire training images under a sub-folder of Input/Images/, and run
...
###  Random samples
To generate random samples from any starting generation scale, please first train the model for the desire images (as described above), and then run 
...
# For additional informaiton- see SinGAN:
